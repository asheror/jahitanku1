...
<!-- Mirrored from themesflat.co/html/ecomus/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Sep 2024 12:28:00 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        @foreach ($blogs as $blog)
                            <div class="blog-article-item style-row">
                                <div class="article-thumb">
                                    ...
                                    <img class="lazyload" data-src="{{ asset('storage/' . $blog->gambar) }}" 
                                    src="{{ asset('storage/' . $blog->gambar) }}" alt="img-blog">
                                    </a>
                                </div>
                                <div class="article-content">
                                    
                                    <div class="article-title">
                                        <a href="blog-detail.html" class="">{{ $blog->judul }}</a>
                                    </div>
                                    <div class="desc">
                                    {{ Str::limit($blog->isi_blog, 100, '...') }}
                                    </div>
