...
<body class="preload-wrapper">
            ...
            <tr>
                <td>
                    <a href="product-detail.html" class="img-box">
                        <img src="{{ asset('storage/' . $item['foto']) }}" alt="img-product" width="100">
                    </a>
                    <div class="cart-info">
                        <a href="product-detail.html" class="cart-title link">{{ $item['nama_produk'] }}</a>
                    </div>
                </td>
                ...
                <td>
                    <form action="{{ route('cart.update', $id) }}" method="POST">
                        @csrf
                        <input type="number" name="quantity" value="{{ $item['jumlah'] }}" min="1">
                    </form>
                </td>
                <td>Rp{{ number_format($item['subtotal'], 2) }}</td>
                <td>
                    <a href="{{ route('cart.remove', $id) }}" class="remove-cart link">Remove</a>
                </td>
            </tr>
        @endforeach
    </tbody>
    ...
    <div id="subtotal" class="col-md-6">
        ...
        <a href="/checkout" class="normal">
            <button class="tf-btn w-100 btn-fill animate-hover-btn radius-3 justify-content-center">Check Out</button>
        </a>
    </div>
</div>
                        </div>
