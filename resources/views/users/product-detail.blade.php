...
<!-- Mirrored from themesflat.co/html/ecomus/product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Sep 2024 12:26:42 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <nav class="box-navigation text-center">
                            <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                ...
                                <li class="menu-item position-relative">
                                    <a href="blog-list.html" class="item-link">Blog</a>
                                </li>
                                ...
                                <div class="thumbs-slider">
                                    <div class="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                                        <div class="swiper-wrapper stagger-wrap">
                                            ...
                                            <div class="swiper-slide stagger-item">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/shop/products/hmgoepprod.jpg" src="images/shop/products/hmgoepprod.jpg" alt="img-compare">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item">
                                                <div class="item">
                                            ...
                                            <div class="swiper-slide stagger-item">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/shop/products/hmgoepprod6.jpg" src="images/shop/products/hmgoepprod6.jpg" alt="img-compare">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/shop/products/hmgoepprod7.jpg" src="images/shop/products/hmgoepprod7.jpg" alt="img-compare">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/shop/products/hmgoepprod8.jpg" src="images/shop/products/hmgoepprod8.jpg" alt="img-compare">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/shop/products/hmgoepprod9.jpg" src="images/shop/products/hmgoepprod9.jpg" alt="img-compare">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tf-product-info-wrap position-relative">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info-price">
                                        ...
                                        <div class="compare-at-price">Rp.{{ number_format($product->harga, 0, ',', '.') }}</div>
...
<script defer type="text/javascript" src="{{ asset('js/count-down.js') }}"></script>
<script defer type="text/javascript" src="{{ asset('js/bootstrap-select.min.js') }}"></script>
<script defer type="text/javascript" src="{{ asset('js/lazysize.min.js') }}"></script>
<script defer type="text/javascript" src="{{ asset('js/drift.min.js') }}"></script>
<script defer type="text/javascript" src="{{ asset('js/wow.min.js') }}"></script>
<script defer type="text/javascript" src="{{ asset('js/main.js') }}"></script>
<script defer type="module" src="{{ asset('js/model-viewer.min.js') }}"></script>
<script defer type="module" src="{{ asset('js/zoom.js') }}"></script>


</body>


<!-- Mirrored from themesflat.co/html/ecomus/product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Sep 2024 12:26:50 GMT -->
</html>