...
<!-- Mirrored from themesflat.co/html/ecomus/my-account-edit.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Sep 2024 12:32:59 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="preload-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="my-account-content account-edit">
                            <div class="">
                            <form class="" id="form-password-change" action="{{ route('profile.update') }}" method="POST">
    @csrf
    <div class="tf-field style-1 mb_15">
        <input class="tf-field-input tf-input" placeholder=" " type="email" id="property1" name="email" value="{{ old('email', $user->email) }}">
        <label class="tf-field-label fw-4 text_black-2" for="property1">Email</label>
    </div>
    <div class="tf-field style-1 mb_15">
        <input class="tf-field-input tf-input" placeholder=" " type="text" id="property2" name="address" value="{{ old('address', $user->address) }}">
    ...
    <div class="tf-field style-1 mb_30">
        ...
        <label class="tf-field-label fw-4 text_black-2" for="property4">New password</label>
    </div>
    <div class="tf-field style-1 mb_30">
        <input class="tf-field-input tf-input" placeholder=" " type="password" id="property5" name="password_confirmation">
