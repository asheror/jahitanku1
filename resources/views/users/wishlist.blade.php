...
<!-- Mirrored from themesflat.co/html/ecomus/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Sep 2024 12:28:02 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="card-product-wrapper">
                ...
                <div class="product-img">
                    <img class="lazyload img-product" 
                         data-src="{{ asset('storage/' . $wishlist->product->foto) }}" 
                         src="{{ asset('storage/' . $wishlist->product->foto) }}" 
                         alt="{{ $wishlist->product->nama_produk }}">
                </div>
                ...
                <div class="list-product-btn type-wishlist">
                    <form method="POST" action="{{ route('wishlist.remove', $wishlist->id) }}">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="box-icon bg_white wishlist">
                ...
                <div class="card-product-info">
                    <a class="title link">
                        {{ $wishlist->product->nama_produk }}
                    </a>
                    <span class="price">Rp{{ number_format($wishlist->product->harga, 2) }}</span>
                </div>
            </div>
        </div>
        @endforeach
...
<!-- Mirrored from themesflat.co/html/ecomus/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Sep 2024 12:28:03 GMT -->
</html>