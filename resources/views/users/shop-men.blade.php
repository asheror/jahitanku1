...
<!-- Mirrored from themesflat.co/html/ecomus/shop-men.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Sep 2024 12:26:41 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="preload-wrapper">
    ...
    <div id="wrapper">
        ...
        <div class="tf-page-title">
            <div class="container-full">
                <div class="heading text-center">Toko</div>
            </div>
        </div>
        <!-- /page-title -->
    ...
    <div class="card-product">
        <div class="card-product-wrapper">
            <a href="" class="product-img">
                <img class="lazyload img-product" data-src="{{ asset('storage/' . $product->foto) }}" 
                     src="{{ asset('storage/' . $product->foto) }}" alt="{{ $product->nama_produk }}">
            </a>

            <div class="list-product-btn">
                <a href="{{ route('cart.add', $product->id_produk) }}" class="box-icon bg_white quick-add tf-btn-loading">
                    <span class="icon icon-bag"></span>
                    <span class="tooltip">Quick Add</span>
                </a>

                <a href="#" onclick="event.preventDefault(); document.getElementById('wishlist-form-{{ $product->id_produk }}').submit();" 
                ...
                <form id="wishlist-form-{{ $product->id_produk }}" method="POST" action="{{ route('wishlist.add') }}" style="display: none;">
                    @csrf
                ...
                <a href="{{ route('product.details', ['id_produk' => $product->id_produk]) }}"
   ...
   <span class="tooltip">Quick View</span>
        ...
        <div class="card-product-info">
            <a href="#" class="title link">{{ $product->nama_produk }}</a>
            <span class="price">Rp{{ number_format($product->harga, 2) }}</span>
        </div>
    </div>
    @endforeach
</div>
