...
<!-- Mirrored from themesflat.co/html/ecomus/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Sep 2024 12:23:33 GMT -->
<head>
    <meta charset="utf-8">
    <title>Jahitanku - Ultimate HTML</title>
   ...
   <link rel="stylesheet"type="text/css" href="css/styles.css"/>
    ...
    <link rel="shortcut icon" href="images/logo/J.png">
<link rel="apple-touch-icon-precomposed" href="images/logo/J.png">
...
<body class="preload-wrapper popup-loader">
    ...
    <div id="wrapper">
                        ...
                        <div class="swiper tf-sw-top_bar" data-preview="1" data-space="0" data-loop="true" data-speed="1000" data-delay="2000">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <p class="top-bar-text fw-5">Promo musim panas<a href="shop-default.html" title="all collection" class="tf-btn btn-line">Belanja sekarang<i class="icon icon-arrow1-top-left"></i></a></p>
                                </div>
                                <div class="swiper-slide">
                                    <p class="top-bar-text fw-5">Dukung penjahit di Indonesia</p>
                                </div>
                                <div class="swiper-slide">
                                    <p class="top-bar-text fw-5">Tampil modis dengan produk lokal</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="top-bar-language tf-cur justify-content-end">
                        ...
                        <div class="tf-currencies">
                            <select class="image-select center style-default type-currencies">
                                <option data-thumbnail="images/country/idn.jpeg">IDR <span>Rp | Rupiah</span></option>
                ...
                <div class="row wrapper-header align-items-center">
                    ...
                    <div class="col-xl-3 col-md-4 col-6">
                        <a href="index.html" class="logo-header">
                            <img src="images/logo/Jahitanku.svg" alt="logo" class="logo">
                        </a>
                    </div>
                    <div class="col-xl-6 tf-md-hidden">
                        <nav class="box-navigation text-center">
                            <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                            ...
                                            <div class="row-demo">
                                                <div class="demo-item">
                                                    <a href="index.html">
                                                        ...
                                                        <span class="demo-name">Beranda</span>
                                                    </a>
                                                </div>
                                        </div>
                                    </div>
                                ...
                                <li class="menu-item">
                                    <a href="{{ url('/shop') }}" class="item-link">Toko<i class="icon icon-arrow-down"></i></a>
                                    <div class="sub-menu mega-menu">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-lg-2">
                                                    <div class="mega-menu-item">
                                                        <div class="menu-heading">Rekomendasi</div>
                                                        <ul class="menu-list">
                                                            <li><a href="{{ url('/shop') }}" class="menu-link-text link">Christian Dior</a></li>
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Yves Saint Laurent</a></li>
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Armani</a></li>
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Chrome Hearts</a></li>
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Bottega Veneta</a></li>
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Chanel</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <div class="mega-menu-item">
                                                        <div class="menu-heading">Disponsori</div>
                                                        <ul class="menu-list">
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Prada</a></li>
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Versace</a></li>
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Ralph Lauren</a></li>
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Alexandre Vauthier</a></li>
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Alexander McQueen</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <div class="mega-menu-item">
                                                        <div class="menu-heading">Paling Banyak diKunjungi</div>
                                                        <ul class="menu-list">
                                                            <li><a href="product-style-list.html" class="menu-link-text link">Alexandre Vauthier</a></li>
                                                            <li><a href="product-style-01.html" class="menu-link-text link">Versace</a></li>
                                                            <li><a href="product-style-02.html" class="menu-link-text link">Hermès</a></li>
                                                            </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            ...
                                                            <div class="collection-content">
                                                                <a href="shop-men.html" class="tf-btn hover-icon btn-xl collection-title fs-16"><span>Pria</span><i class="icon icon-arrow1-top-left"></i></a>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            ...
                                                            <div class="collection-content">
                                                                <a href="shop-women.html" class="tf-btn btn-xl collection-title fs-16 hover-icon"><span>Wanita</span><i class="icon icon-arrow1-top-left"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <li class="menu-item">
                                    <a href="#" class="item-link">Kategori<i class="icon icon-arrow-down"></i></a>
                                    <div class="sub-menu mega-menu">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-lg-2">
                                                    <div class="mega-menu-item">
                                                        <div class="menu-heading"><a href="shop-men.html">Pria</a></div>
                                                        <ul class="menu-list">
                                                            <li><a href="shop-men.html" class="menu-link-text link">Jeans</a></li>
                                                            <li><a href="shop-men.html" class="menu-link-text link">Kaos</a></li>
                                                            <li><a href="shop-men.html" class="menu-link-text link">Kemeja</a></li>
                                                            <li><a href="shop-men.html" class="menu-link-text link">Batik</a></li>
                                                            <li><a href="shop-men.html" class="menu-link-text link">Celana</a></li>
                                                            <li><a href="shop-men.html" class="menu-link-text link">Jaket</a></li>
                                                            </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <div class="mega-menu-item">
                                                        <div class="menu-heading"><a href="shop-women.html">Wanita</a></div>
                                                        <ul class="menu-list">
                                                            <li><a href="shop-women.html" class="menu-link-text link">Rok</a></li>
                                                            <li><a href="shop-women.html" class="menu-link-text link">Jeans</a></li>
                                                            <li><a href="shop-women.html" class="menu-link-text link">Blus</a></li>
                                                            <li><a href="shop-women.html" class="menu-link-text link">Kemeja</a></li>
                                                            <li><a href="shop-women.html" class="menu-link-text link">Kaos</a></li>
                                                            <li><a href="shop-women.html" class="menu-link-text link">Gaun</a></li>
                                                            </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <div class="mega-menu-item">
                                                        <div class="menu-heading">Aksesoris</div>
                                                        <ul class="menu-list">
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Sepatu</a></li>
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Kalung</a></li>
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Gelang</a></li>
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Jam Tangan</a></li></ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <div class="mega-menu-item">
                                                        <div class="menu-heading">Lainnya</div>
                                                        <ul class="menu-list">
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">vest</a></li>
                                                           </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="menu-heading">Terlaris</div>
                                                            ...
                                                            <div class="swiper-wrapper">
                                                                        ...
                                                                        <div class="card-product-wrapper">
                                                                            ...
                                                                            <div class="list-product-btn">
                                                                                <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                                                    ...
                                                                                    <span class="tooltip">Tambahkan</span>
                                                                                </a>
                                                                                <a href="javascript:void(0);" class="box-icon bg_white wishlist btn-icon-action">
                                                                                    <span class="icon icon-heart"></span>
                                                                                    <span class="tooltip">Tambahkan ke Wishlist</span>
                                                                                    <span class="icon icon-delete"></span>
                                                                                </a>
                                                                                
                                                                                <a href="#quick_view" data-bs-toggle="modal" class="box-icon bg_white quickview tf-btn-loading">
                                                                                    <span class="icon icon-view"></span>
                                                                                    <span class="tooltip">Tampilan Cepat</span>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="card-product-info">
                                                                            <a href="#" class="title link">Tank Top Bergaris</a>
                                                                            <span class="price">Rp.50.000,00</span>
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                                    <span class="tooltip">Oranye</span>
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="#" class="title link">Kaos Oblong Bermotif Besar</a>
                                                                            <span class="price">Rp.30.000,00</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="#" class="title">Tank Top Bergaris</a>
                                                                            <span class="price">Rp.50.000,00</span>
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="#" class="title link">Kaos linen dengan leher V</a>
                                ...
                                <li class="menu-item position-relative">
                                    <a href="{{ url('/Blog') }}" class="item-link">Blog</a>
                                </li>
                                <li class="menu-item"><a href="{{ url('/shop') }}" class="item-link">Thrift</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="col-xl-3 col-md-4 col-3">
                        <ul class="nav-icon d-flex justify-content-end align-items-center gap-20">
                            ...
                            <li class="nav-account"><a href="{{ route('profile') }}" class="site-nav-icon"><i class="icon icon-account"></i></a></li>
                            <li class="nav-wishlist"><a href="{{ url(path: 'wishlist') }}" class="nav-icon-item"><i class="icon icon-heart"></i><span class="count-box">3</span></a></li>
                            <li class="nav-cart"><a href="#shoppingCart" data-bs-toggle="modal" class="nav-icon-item"><i class="icon icon-bag"></i><span class="count-box">2</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            ...
                            <div class="box-content">
                                <div class="container">
                                    <h1 class="fade-item fade-item-1">Fashion Handmade<br>untuk Anda</h1>
                                    <p class="fade-item fade-item-2">Temukan kesempurnaan disetiap Jahitan</p>
                                    <a href="shop-collection-sub.html" class="fade-item fade-item-3 tf-btn btn-fill animate-hover-btn btn-xl radius-3"><span>Beli Koleksinya</span><i class="icon icon-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            ...
                            <div class="box-content">
                                <div class="container">
                                    <h1 class="fade-item fade-item-1">Jahitanku, <br class="md-hidden">Gaya yang personal</h1>
                                    <p class="fade-item fade-item-2">Kami ciptakan, Anda kenakan</p>
                                    <a href="shop-default.html" class="fade-item fade-item-3 tf-btn btn-fill animate-hover-btn btn-xl radius-3"><span>Beli Koleksinya</span><i class="icon icon-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            ...
                            <div class="box-content">
                                <div class="container">
                                    <h1 class="fade-item fade-item-1">Jahitan Sempurna<br> Gaya Elegan</h1>
                                    <p class="fade-item fade-item-2">Desain eksklusif yang dibuat Khusus untuk Anda</p>
                                    <a href="shop-collection-sub.html" class="fade-item fade-item-3 tf-btn btn-fill animate-hover-btn btn-xl radius-3"><span>Beli koleksinya</span><i class="icon icon-arrow-right"></i></a>
                                </div>
                            </div>
        ...
        <div class="tf-marquee bg_yellow-2">
            <div class="wrap-marquee">
                <div class="marquee-item">
                    ...
                    <p class="text">Promo Besar Besaran Diskon Sampai 70%</p>
                </div>
                <div class="marquee-item">
                    <div class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="" width="15" height="20" viewBox="0 0 15 20"><path d="M14.5833 8H8.61742L9.94318 0L0 12H5.96591L4.64015 20L14.5833 8"></path></svg>
        ...
        <section class="flat-spacing-4 flat-categorie">
            <div class="container-full">
               <div class="flat-title-v2">
                    ...
                    <span class="text-3 fw-7 text-uppercase title wow fadeInUp" data-wow-delay="0s">BELANJA MENGGUNAKAN KATEGORI</span>
               </div>
               <div class="row">
                                ...
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            ...
                                            <div class="collection-content">
                                                <a href="shop-default.html" class="tf-btn collection-title hover-icon fs-15"><span>Pakaian</span><i class="icon icon-arrow1-top-left"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            ...
                                            <div class="collection-content">
                                                <a href="shop-default.html" class="tf-btn collection-title hover-icon fs-15"><span>Kacamata</span><i class="icon icon-arrow1-top-left"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            ...
                                            <div class="collection-content">
                                                <a href="shop-default.html" class="tf-btn collection-title hover-icon fs-15"><span>Tas</span><i class="icon icon-arrow1-top-left"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide" lazy="true">
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            ...
                                            <div class="collection-content">
                                                <a href="shop-default.html" class="tf-btn collection-title hover-icon fs-15"><span>Aksesoris</span><i class="icon icon-arrow1-top-left"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="flat-spacing-5 pt_0 flat-seller">
            <div class="container">
                <div class="flat-title">
                    <span class="title wow fadeInUp" data-wow-delay="0s">Terlaris</span>
                    <p class="sub-title wow fadeInUp" data-wow-delay="0s">Belanja dengan Gaya Terbaru: Tetap terdepan dengan style baru kami</p>
                </div>
                <div class="grid-layout loadmore-item wow fadeInUp" data-wow-delay="0s" data-grid="grid-4">
                    ...
                    <div class="card-product fl-item">
                        ...
                        <div class="card-product-info">
                            <a href="product-detail.html" class="title link">Tank Top Bergaris</a>
                            <span class="price">Rp.50.000,00</span>
                            <ul class="list-color-product">
                                <li class="list-color-item color-swatch active">
                                    <span class="tooltip">Oranye</span>
                    ...
                    <div class="card-product fl-item">
                        ...
                        <div class="card-product-info">
                            <a href="product-detail.html" class="title link">Kaos Bergaris</a>
                            <span class="price">Dari Rp.30.000,00</span>
                            <ul class="list-color-product">
                                <li class="list-color-item color-swatch active">
                                    <span class="tooltip">Brown</span>
                                    <span class="swatch-value bg_brown"></span>
                    ...
                    <div class="card-product fl-item">
                        ...
                        <div class="card-product-info">
                            <a href="product-detail.html" class="title link">Kaos Oversized Bermotif</a>
                            <span class="price">Rp.30.000,00</span>
                        </div>
                    </div>
                    <!-- card product 4 -->
                    <div class="card-product fl-item">
                        ...
                        <div class="card-product-info">
                            <a href="product-detail.html" class="title">Kaos Oversize bermotif</a>
                            <span class="price">Rp.30.000,00</span>
                            <ul class="list-color-product">
                                <li class="list-color-item color-swatch active">
                                    <span class="tooltip">White</span>
                    ...
                    <div class="card-product fl-item">
                        ...
                        <div class="card-product-info">
                            <a href="product-detail.html" class="title link">Kaos Linen V-neck</a>
                    ...
                    <div class="card-product fl-item">
                        ...
                        <div class="card-product-info">
                            <a href="product-detail.html" class="title link">Kaos Longgar</a>
                            <span class="price">Rp.30.000,00</span>
                            <ul class="list-color-product">
                                <li class="list-color-item color-swatch active">
                                    <span class="tooltip">Light Green</span>
                    ...
                    <div class="card-product fl-item">
                        ...
                        <div class="card-product-info">
                            <a href="product-detail.html" class="title link">Kaos Oxford</a>
                            <span class="price">Rp.30.000,00</span>
                            <ul class="list-color-product">
                                <li class="list-color-item color-swatch active">
                                    <span class="tooltip">Black</span>
                    ...
                    <div class="card-product fl-item">
                        ...
                        <div class="card-product-info">
                            <a href="product-detail.html" class="title link">Hoodie Longgar</a>
                            <span class="price">Rp.30.000,00</span>
                            <ul class="list-color-product">
                                <li class="list-color-item color-swatch active">
                                    <span class="tooltip">White</span>
                    ...
                    <div class="card-product fl-item">
                        ...
                        <div class="card-product-info">
                            <a href="product-detail.html" class="title link">Syal bermotif</a>
                    ...
                    <div class="card-product fl-item">
                        ...
                        <div class="card-product-info">
                            <a href="product-detail.html" class="title link">Sweater Turtleneck Rajutan</a>
                            <span class="price">Rp.50.000,00</span>
                            <ul class="list-color-product">
                                <li class="list-color-item color-swatch active">
                                    <span class="tooltip">Black</span>
                ...
                <div class="tf-pagination-wrap view-more-button text-center">
                    <button class="tf-btn-loading tf-loading-default style-2 btn-loadmore "><span class="text">Muat lebih banyak</span></button>
                </div>
            </div>
        </section>
        <!-- /Seller -->
        ...
        <section class="flat-spacing-6">
            <div class="flat-title wow fadeInUp" data-wow-delay="0s">
                <span class="title">Belanja Sekarang</span>
                <p class="sub-title">Dapatkan inspirasi dan biarkan diri Anda terinspirasi, dari satu mode unik ke mode unik lainnya.</p>
            </div>
                                                ...
                                                <div class="lookbook-product">
                                                    ...
                                                    <div class="content-wrap">
                                                        <div class="product-title">
                                                            <a href="#">Jersey thong</a>
                                                        </div>
                                                        <div class="price">Rp.250.000,00</div>
                                                    </div>
        ...
        <section class="flat-spacing-5 pt_0 flat-testimonial">
            <div class="container">
                <div class="flat-title wow fadeInUp" data-wow-delay="0s">
                    <span class="title">Kustomer yang Senang</span>
                        ...
                        <div class="swiper-wrapper wrap-iconbox">
                            <div class="swiper-slide">
                                <div class="tf-icon-box style-border-line text-center">
                                    ...
                                    <div class="content">
                                        <div class="title">Gratis Pengiriman</div>
                                        <p>Gratis Pengiriman order di atas Rp.200.000,00</p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="tf-icon-box style-border-line text-center">
                                    ...
                                    <div class="content">
                                        <div class="title">Pembayaran Fleksibel</div>
                                        <p>Bayar dengan Berbagai Kartu Kredit</p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                            ...
                            <div class="swiper-slide">
                                <div class="tf-icon-box style-border-line text-center">
                                    ...
                                    <div class="content">
                                        <div class="title">Dukungan Premium</div>
                                        <p>Dukungan premium yang luar biasa</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-infor">
                                    <div class="footer-logo">
                                        <a href="index.html">
                                            <img src="images/logo/Jahitanku.svg" alt="">
                                        </a>
                                    </div>
                                    <ul>
                                        <li>
                            ...
                            <div class="col-xl-3 col-md-6 col-12 footer-col-block">
                                ...
                                <ul class="footer-menu-list tf-collapse-content">
                                    ...
                                    <li> 
                                        <a href="store-locations.html" class="footer-menu_item">Visit Our Store</a>
                                    </li>
                                    <li>
                                    <li> 
                                ...
                                <div class="footer-newsletter footer-col-block">
                                    ...
                                    <div class="tf-collapse-content">
                                        ...
                                        <div class="tf-cur">
                                            <div class="tf-currencies">
                                                <select class="image-select center style-default type-currencies">
                                                    <option data-thumbnail="images/country/idn.jpeg">IDR <span>Rp. | Indonesia</span></option>
                                                    <option data-thumbnail="images/country/us.svg">USD <span>$ | United States</span></option>
                                                </select>
                                            </div>
                                            <div class="tf-languages">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="footer-bottom-wrap d-flex gap-20 flex-wrap justify-content-between align-items-center">
                                    <div class="footer-menu_item">© 2024 Jahitanku Store. All Rights Reserved</div>
    ...
    <div class="tf-toolbar-bottom type-1150">
        <div class="toolbar-item active">
            <a href="#toolbarShopmb" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft">
                ...
                <div class="toolbar-label">Belanja</div>
            </a>
        </div>
        ...
        <div class="toolbar-item">
            <a href="#canvasSearch" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft">
                ...
                <div class="toolbar-label">Cari</div>
            </a>
        </div>
        <div class="toolbar-item">
            <a href="#login" data-bs-toggle="modal">
                ...
                <div class="toolbar-label">Akun</div>
            </a>
        </div>
        <div class="toolbar-item">
        ...
        <div class="toolbar-item">
            <a href="#shoppingCart" data-bs-toggle="modal">
                ...
                <div class="toolbar-label">Keranjang</div>
            </a>
        </div>
    </div>
    <!-- /toolbar-bottom -->
        ...
        <div class="mb-canvas-content">
            ...
            <div class="mb-bottom">
                ...
                <div class="bottom-bar-language">
                    <div class="tf-currencies">
                        <select class="image-select center style-default type-currencies">
                            <option data-thumbnail="images/country/fr.svg">IDN <span>Rp | Indonesia</span></option>
                            <option data-thumbnail="images/country/de.svg">USD <span>$ | United States</span></option>
                        </select>
                    </div>
                    <div class="tf-languages">
                        <select class="image-select center style-default type-languages">
            ...
            <header class="tf-search-head">
                ...
                <div class="tf-search-sticky">
                    <form class="tf-mini-search-frm">
                        <fieldset class="text">
                            <input type="text" placeholder="Cari" class="" name="text" tabindex="0" value="" aria-required="true" required="">
                        </fieldset>
                        ...
                        <div class="tf-col-quicklink">
                            ...
                            <ul class="tf-quicklink-list">
                                <li class="tf-quicklink-item">
                                    <a href="shop-collection-sub.html" class="">Fashion</a>
                                </li>
                                <li class="tf-quicklink-item">
                                    <a href="shop-men.html" class="">Pria</a>
                                </li>
                                <li class="tf-quicklink-item">
                                    <a href="shop-women.html" class="">Wanita</a>
                                </li>
                                <li class="tf-quicklink-item">
                                    <a href="shop-collection-sub.html" class="">Aksesoris</a>
                                </li>
                            </ul>
                        </div>
                        <div class="tf-col-content">
                            <div class="tf-search-content-title fw-5">Butuh Inspirasi?</div>
                            <div class="tf-search-hidden-inner">
                                <div class="tf-loop-item">
                                    ...
                                    <div class="content">
                                        <a href="product-detail.html">Atasan Jersey Katun</a>
                                        <div class="tf-product-info-price">
                                            <div class="compare-at-price">Rp.20.000,00</div>
                                            <div class="price-on-sale fw-6">Rp.15.000,00</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tf-loop-item">
                                    ...
                                    <div class="content">
                                        <a href="product-detail.html">Tas Selempang Mini</a>
                                        <div class="tf-product-info-price">
                                            <div class="price fw-6">Rp.20.000,00</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tf-loop-item">
                                    ...
                                    <div class="content">
                                        <a href="product-detail.html">Kaos Ovesize Bermotif</a>
                                        <div class="tf-product-info-price">
                                            <div class="price fw-6">Rp.20.000,00</div>
                                        </div>
                                    </div>
    ...
    <div class="offcanvas offcanvas-start canvas-mb toolbar-shop-mobile" id="toolbarShopmb">
        ...
        <div class="mb-canvas-content">
            ...
            <div class="mb-bottom">
                <a href="shop-default.html" class="tf-btn fw-5 btn-line">Lihat Semua Koleksinya<i class="icon icon-arrow1-top-left"></i></a>
            </div>
        </div>       
    </div>
    <!-- /toolbarShopmb -->
            ...
            <div class="modal-content">
                ...
                <div class="tf-login-form">
                    <form class="" action="https://themesflat.co/html/ecomus/my-account.html" accept-charset="utf-8">
                        ...
                        <div>
                            <a href="#forgotPassword" data-bs-toggle="modal" class="btn-link link">Lupa kata Sandi anda?</a>
                        </div>
                        <div class="bottom"> 
                            <div class="w-100">
    ...
    <div class="modal modalCentered fade form-sign-in modal-part-content" id="forgotPassword">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="header">
                    <div class="demo-title">Setel ulang kata sandi Anda</div>
                    <span class="icon-close icon-close-popup" data-bs-dismiss="modal"></span>
                </div>
                <div class="tf-login-form">
                    <form class="">
                        <div>
                            <p>Daftar untuk akses Penjualan awal plus pendatang baru, tren, dan promosi yang disesuaikan. Untuk berhenti berlangganan, klik berhenti berlangganan di email kami</p>
                        </div>
                        <div class="tf-field style-1">
                            <input class="tf-field-input tf-input" placeholder=" " type="email"  name="">
                            <label class="tf-field-label" for="">Email *</label>
            ...
            <div class="modal-content">
                ...
                <div class="wrap">
                    <div class="tf-product-info-item">
                        ...
                        <div class="content">
                            <a href="product-detail.html">Tank Top Bergaris</a>
                            <div class="tf-product-info-price">
                    ...
                    <div class="tf-product-info-variant-picker mb_15">
                        <div class="variant-picker-item">
                            <div class="variant-picker-label">
                                Warna: <span class="fw-6 variant-picker-label-value">Oranye</span>
                            </div>
                        ...
                        <div class="variant-picker-item">
                            <div class="variant-picker-label">
                                Ukuran: <span class="fw-6 variant-picker-label-value">S</span>
                            </div>
                            <div class="variant-picker-values">
                    ...
                    <div class="tf-product-info-buy-button">
                        <form>
                            <a href="javascript:void(0);" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Tambahkan ke Keranjang -&nbsp;</span><span class="tf-qty-price">Rp.50.000,00</span></a>
                            ...
                            <div class="w-100">
                                <a href="#" class="btns-full">Bayar dengan <img src="images/payments/paypal.png" alt=""></a>
                                <a href="#" class="payment-more-option">Pilihan Pembayaran Lainnya</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<!-- Mirrored from themesflat.co/html/ecomus/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Sep 2024 12:24:45 GMT -->
</html>