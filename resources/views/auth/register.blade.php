    ...
    <div id="wrapper">
                ...
                <div class="row wrapper-header align-items-center">
                    ...
                    <div class="col-xl-6 tf-md-hidden">
                        <nav class="box-navigation text-center">
                            <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                ...
                                <li class="menu-item">
                                    <a href="#" class="item-link">Toko<i class="icon icon-arrow-down"></i></a>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-2">
                                                    <div class="mega-menu-item">
                                                        ...
                                                        <ul class="menu-list">
                                                            <li><a href="shop-collection-sub.html" class="menu-link-text link">Christian Dior</a></li>
                                ...
                                <li><a href="{{ url('/Blog') }}"><i class="fas fa-clipboard-list"></i> Blog</a></li>
                                </li>
                                <li class="menu-item"><a href="shop-collection-sub.html" class="item-link">Thrift</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="col-xl-3 col-md-4 col-3">
                        <ul class="nav-icon d-flex justify-content-end align-items-center gap-20">
                            ...
                            <li class="nav-wishlist"><a href="wishlist.html" class="nav-icon-item"><i class="icon icon-heart"></i><span class="count-box">6</span></a></li>
        ...
        <div class="tf-page-title style-2">
            <div class="container-full">
                <div class="heading text-center">Registrasi</div>
            </div>
        </div>
        <!-- /page-title -->
    ...
    <div class="container">
        <div class="form-register-wrap">
            <div class="flat-title align-items-start gap-0 mb_30 px-0">
                <h5 class="mb_18">Registrasi</h5>
                </div>
            <div>
                <form id="register-form" action="{{ route('register.store') }}" method="post" accept-charset="utf-8" data-mailchimp="true">
                    @csrf <!-- Add CSRF token for security -->
                    <div class="tf-field style-1 mb_15">
                        <input class="tf-field-input tf-input" placeholder=" " type="text" id="property1" name="first_name" required>
                        <label class="tf-field-label fw-4 text_black-2" for="property1">Nama Depan</label>
                    </div>
                    <div class="tf-field style-1 mb_15">
                        <input class="tf-field-input tf-input" placeholder=" " type="text" id="property2" name="last_name" required>
                        <label class="tf-field-label fw-4 text_black-2" for="property2">Nama Belakang</label>
                    </div>
                    <div class="tf-field style-1 mb_15">
                    ...
                    <div class="tf-field style-1 mb_15">
                        <input class="tf-field-input tf-input" placeholder=" " type="text" id="property4" name="phone_number" required>
                        <label class="tf-field-label fw-4 text_black-2" for="property4">Nomor Telepon *</label>
                    </div>
                    <div class="tf-field style-1 mb_30">
                        <input class="tf-field-input tf-input" placeholder=" " type="text" id="property5" name="address">
                        <label class="tf-field-label fw-4 text_black-2" for="property5">Alamat</label>
                    </div>
                    <div class="tf-field style-1 mb_30">
                        <input class="tf-field-input tf-input" placeholder=" " type="password" id="property6" name="password" required>
                        <label class="tf-field-label fw-4 text_black-2" for="property6">Kata Sandi *</label>
                    </div>
                    <div class="tf-field style-1 mb_30">
                        <input class="tf-field-input tf-input" placeholder=" " type="password" id="property7" name="password_confirmation" required>
                        <label class="tf-field-label fw-4 text_black-2" for="property7">Konfirmasi Kata Sandi *</label>
                    </div>
                    <div class="mb_20">
                        <button type="submit" class="tf-btn w-100 radius-3 btn-fill animate-hover-btn justify-content-center">Register<a href="{{ url('/1') }}"></button></a>
                    </div>
                    <div class="text-center">
                        <a href="login.html" class="tf-btn btn-line">Sudah mempunyai akun? Log In disini<i class="icon icon-arrow1-top-left"></i></a>
                    </div>
                </form>
            </div>
        </div>
